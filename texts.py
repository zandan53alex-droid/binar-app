...
T: Dict[str, Dict[str, str]] = {
    ...
    'btn_reviews': {
        'ru': '⭐️ Отзывы', 'en': '⭐️ Reviews', 'hi': '⭐️ समीक्षा', 'es': '⭐️ Reseñas'
    },
    'btn_support': {
    ...
    'btn_open_miniapp': {
        'ru': '🔓 Открыть доступ', 'en': '🔓 Open Access',
        'hi': '🔓 मिनी-ऐप खोलें', 'es': '🔓 Abrir acceso'
    },
    ...
    'already_registered': {
        'ru': 'Вы уже зарегистрированы ✅', 'en': 'You are already registered ✅',
        'hi': 'आप पहले से पंजीकृत हैं ✅', 'es': 'Ya estás registrado ✅'
    },
    ...
    'subscribe_title': {
        'ru': '🔗 Шаг 1 — Подключение к сети', 
        'en': '🔗 Step 1 — Network Connection',
        'hi': '🔗 चरण 1 — नेटवर्क कनेक्शन', 
    ...
    'sub_confirmed': {
        'ru': 'Подписка подтверждена ✅', 'en': 'Subscription confirmed ✅',
        'hi': 'सदस्यता की पुष्टि हो गई ✅', 'es': 'Suscripción confirmada ✅'
    },
    'sub_not_yet': {
        ...
        'hi': 'अभी सदस्यता नहीं दिख रही। कृपया चैनल जॉइन करें।',
        'es': 'Aún no veo la suscripción. Únete al canal.'
    },
    ...
    'deposit_text': {
        ...
        'en': '🔋 <b>Trading Module Activation</b>\n\nRegistration successful! The final stage is funding your balance. This is necessary to activate your unique license.\n\n💡 <i>A deposit is your personal capital that you will use to trade based on signals.</i>\n\nMake the minimum deposit to unlock access.',
        'hi': '🔋 <b>ट्रेडिंग मॉड्यूल सक्रियण</b>\n\nपंजीकरण सफल रहा! अंतिम चरण आपके बैलेंस को जमा करना है। यह आपके अद्वितीय लाइसेंस को सक्रिय करने के लिए आवश्यक है।',
        'es': '🔋 <b>Activación del módulo de trading</b>\n\n¡Registro exitoso! La etapa final es financiar su saldo. Esto es necesario para activar su licencia única.'
    },
    ...
    'platinum_text': {
        'ru': (
            ...
            "— Повышенная точность сигналов на волатильных парах.\n\n"
            "Запускайте Mini App и используйте мощь ИИ на максимум!"
        ),
        'en': (
            ...
            "— Increased signal accuracy on volatile pairs.\n\n"
            "Launch the Mini App and use the power of AI to the max!"
        ),
        'hi': (
    ...
    'deposit_need': {
        'ru': 'Необходимо внести', 'en': 'Required',
        'hi': 'आवश्यक राशि', 'es': 'Requerido',
    },
    'deposit_paid': {
        'ru': 'Внесено', 'en': 'Paid',
    ...
    'deposit_left': {
        ...
        'hi': 'बाकी राशि', 'es': 'Falta por aportar',
    },
}
