const ASSETS_DB = {
    forex: [
        { id: 'aedcny_otc', name: 'AED/CNY OTC', icon: 'https://flagcdn.com/w80/ae.png', category: 'Forex' },
        { id: 'audcad_otc', name: 'AUD/CAD OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'audnzd_otc', name: 'AUD/NZD OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'audusd_otc', name: 'AUD/USD OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'bhdcny_otc', name: 'BHD/CNY OTC', icon: 'https://flagcdn.com/w80/bh.png', category: 'Forex' },
        { id: 'cadchf_otc', name: 'CAD/CHF OTC', icon: 'https://flagcdn.com/w80/ca.png', category: 'Forex' },
        { id: 'cadjpy_otc', name: 'CAD/JPY OTC', icon: 'https://flagcdn.com/w80/ca.png', category: 'Forex' },
        { id: 'eurchf_otc', name: 'EUR/CHF OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'eurusd_otc', name: 'EUR/USD OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'nzdusd_otc', name: 'NZD/USD OTC', icon: 'https://flagcdn.com/w80/nz.png', category: 'Forex' },
        { id: 'uahusd_otc', name: 'UAH/USD OTC', icon: 'https://flagcdn.com/w80/ua.png', category: 'Forex' },
        { id: 'usdcop_otc', name: 'USD/COP OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdegp_otc', name: 'USD/EGP OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdidr_otc', name: 'USD/IDR OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdpkr_otc', name: 'USD/PKR OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdrub_otc', name: 'USD/RUB OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdcnh_otc', name: 'USD/CNH OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'eurnzd_otc', name: 'EUR/NZD OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        ...
        { id: 'usdchf_otc', name: 'USD/CHF OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'eurgbp_otc', name: 'EUR/GBP OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'sarcny_otc', name: 'SAR/CNY OTC', icon: 'https://flagcdn.com/w80/sa.png', category: 'Forex' },
        { id: 'cadchf', name: 'CAD/CHF', icon: 'https://flagcdn.com/w80/ca.png', category: 'Forex' },
        { id: 'eurtry_otc', name: 'EUR/TRY OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'audcad', name: 'AUD/CAD', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'eurrub_otc', name: 'EUR/RUB OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'qarcny_otc', name: 'QAR/CNY OTC', icon: 'https://flagcdn.com/w80/qa.png', category: 'Forex' },
        { id: 'audjpy_otc', name: 'AUD/JPY OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'gbpusd_otc', name: 'GBP/USD OTC', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' },
        { id: 'usdbdt_otc', name: 'USD/BDT OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'omrcny_otc', name: 'OMR/CNY OTC', icon: 'https://flagcdn.com/w80/om.png', category: 'Forex' },
        { id: 'usdbrl_otc', name: 'USD/BRL OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        ...
        { id: 'eurjpy_otc', name: 'EUR/JPY OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'gbpaud_otc', name: 'GBP/AUD OTC', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' },
        { id: 'usdars_otc', name: 'USD/ARS OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdcad_otc', name: 'USD/CAD OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdsgd_otc', name: 'USD/SGD OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'kesusd_otc', name: 'KES/USD OTC', icon: 'https://flagcdn.com/w80/ke.png', category: 'Forex' },
        ...
        { id: 'nzdjpy_otc', name: 'NZD/JPY OTC', icon: 'https://flagcdn.com/w80/nz.png', category: 'Forex' },
        ...
        { id: 'usdclp_otc', name: 'USD/CLP OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdjpy', name: 'USD/JPY', icon: 'https://flagcdn.com/w80/jp.png', category: 'Forex' },
        { id: 'audchf_otc', name: 'AUD/CHF OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'gbpjpy_otc', name: 'GBP/JPY OTC', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' },
        ...
        { id: 'madusd_otc', name: 'MAD/USD OTC', icon: 'https://flagcdn.com/w80/ma.png', category: 'Forex' },
        { id: 'usdmxn_otc', name: 'USD/MXN OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'gbpcad', name: 'GBP/CAD', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' },
        { id: 'usdinr_otc', name: 'USD/INR OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        ...
        { id: 'usdthb_otc', name: 'USD/THB OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'jodcny_otc', name: 'JOD/CNY OTC', icon: 'https://flagcdn.com/w80/jo.png', category: 'Forex' },
        { id: 'tndusd_otc', name: 'TND/USD OTC', icon: 'https://flagcdn.com/w80/tn.png', category: 'Forex' },
        { id: 'lbpusd_otc', name: 'LBP/USD OTC', icon: 'https://flagcdn.com/w80/lb.png', category: 'Forex' },
        { id: 'chfnok_otc', name: 'CHF/NOK OTC', icon: 'https://flagcdn.com/w80/ch.png', category: 'Forex' },
        { id: 'euraud', name: 'EUR/AUD', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'eurhuf_otc', name: 'EUR/HUF OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'yerusd_otc', name: 'YER/USD OTC', icon: 'https://flagcdn.com/w80/ye.png', category: 'Forex' },
        { id: 'gbpaud', name: 'GBP/AUD', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' },
        { id: 'ngnusd_otc', name: 'NGN/USD OTC', icon: 'https://flagcdn.com/w80/ng.png', category: 'Forex' },
        { id: 'usdmyr_otc', name: 'USD/MYR OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdphp_otc', name: 'USD/PHP OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'chfjpy_otc', name: 'CHF/JPY OTC', icon: 'https://flagcdn.com/w80/ch.png', category: 'Forex' },
        { id: 'usdvnd_otc', name: 'USD/VND OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usdchf', name: 'USD/CHF', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'usddzd_otc', name: 'USD/DZD OTC', icon: 'https://flagcdn.com/w80/dz.png', category: 'Forex' }
    ],
    crypto: [
