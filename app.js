const ASSETS_DB = {
    ...
    crypto: [
        { id: 'ada_otc', name: 'Cardano OTC', icon: 'https://cryptoicons.org/api/icon/ada/200', category: 'Crypto' },
        { id: 'bnb_otc', name: 'BNB OTC', icon: 'https://cryptoicons.org/api/icon/bnb/200', category: 'Crypto' },
        { id: 'bitcoin_etf_otc', name: 'Bitcoin ETF OTC', icon: 'https://cryptoicons.org/api/icon/btc/200', category: 'Crypto' },
        { id: 'sol_otc', name: 'Solana OTC', icon: 'https://cryptoicons.org/api/icon/sol/200', category: 'Crypto' },
        { id: 'bitcoin_otc', name: 'Bitcoin OTC', icon: 'https://cryptoicons.org/api/icon/btc/200', category: 'Crypto' },
        { id: 'ton_otc', name: 'Toncoin OTC', icon: 'https://assets.coingecko.com/coins/images/17980/large/ton_symbol.png', category: 'Crypto' },
        { id: 'avax_otc', name: 'Avalanche OTC', icon: 'https://cryptoicons.org/api/icon/avax/200', category: 'Crypto' },
        { id: 'link_otc', name: 'Chainlink OTC', icon: 'https://cryptoicons.org/api/icon/link/200', category: 'Crypto' },
        { id: 'matic_otc', name: 'Polygon OTC', icon: 'https://cryptoicons.org/api/icon/matic/200', category: 'Crypto' },
        { id: 'trx_otc', name: 'TRON OTC', icon: 'https://cryptoicons.org/api/icon/trx/200', category: 'Crypto' },
        { id: 'eth_otc', name: 'Ethereum OTC', icon: 'https://cryptoicons.org/api/icon/eth/200', category: 'Crypto' },
        { id: 'ltc_otc', name: 'Litecoin OTC', icon: 'https://cryptoicons.org/api/icon/ltc/200', category: 'Crypto' },
        { id: 'bitcoin', name: 'Bitcoin', icon: 'https://cryptoicons.org/api/icon/btc/200', category: 'Crypto' },
        { id: 'doge_otc', name: 'Dogecoin OTC', icon: 'https://cryptoicons.org/api/icon/doge/200', category: 'Crypto' },
        { id: 'dash', name: 'Dash', icon: 'https://cryptoicons.org/api/icon/dash/200', category: 'Crypto' },
        { id: 'bcheur', name: 'BCH/EUR', icon: 'https://cryptoicons.org/api/icon/bch/200', category: 'Crypto' },
        { id: 'bchgbp', name: 'BCH/GBP', icon: 'https://cryptoicons.org/api/icon/bch/200', category: 'Crypto' },
        { id: 'bchjpy', name: 'BCH/JPY', icon: 'https://cryptoicons.org/api/icon/bch/200', category: 'Crypto' },
        { id: 'btcgbp', name: 'BTC/GBP', icon: 'https://cryptoicons.org/api/icon/btc/200', category: 'Crypto' },
        { id: 'btcjpy', name: 'BTC/JPY', icon: 'https://cryptoicons.org/api/icon/btc/200', category: 'Crypto' },
        { id: 'ethereum', name: 'Ethereum', icon: 'https://cryptoicons.org/api/icon/eth/200', category: 'Crypto' },
        { id: 'dot_otc', name: 'Polkadot OTC', icon: 'https://cryptoicons.org/api/icon/dot/200', category: 'Crypto' },
        { id: 'link', name: 'Chainlink', icon: 'https://cryptoicons.org/api/icon/link/200', category: 'Crypto' }
    ],
    commodities: [
    ...
    stocks: [
        { id: 'amzn_otc', name: 'Amazon OTC', icon: 'https://img.icons8.com/color/100/amazon.png', category: 'Stocks' },
        { id: 'mara_otc', name: 'Marathon Digital Holdings OTC', icon: 'https://img.icons8.com/color/100/bitcoin--v1.png', category: 'Stocks' },
        { id: 'csco_otc', name: 'Cisco OTC', icon: 'https://img.icons8.com/color/100/cisco.png', category: 'Stocks' },
        { id: 'xom_otc', name: 'ExxonMobil OTC', icon: 'https://img.icons8.com/color/100/gas-station.png', category: 'Stocks' },
        { id: 'visa_otc', name: 'VISA OTC', icon: 'https://img.icons8.com/color/100/visa.png', category: 'Stocks' },
        { id: 'gme_otc', name: 'GameStop Corp OTC', icon: 'https://img.icons8.com/color/100/joystick.png', category: 'Stocks' },
        { id: 'mcd_otc', name: "McDonald's OTC", icon: 'https://img.icons8.com/color/100/mcdonalds.png', category: 'Stocks' },
        { id: 'pltr_otc', name: 'Palantir Technologies OTC', icon: 'https://img.icons8.com/color/100/data-configuration.png', category: 'Stocks' },
        { id: 'fdx_otc', name: 'FedEx OTC', icon: 'https://img.icons8.com/color/100/fedex.png', category: 'Stocks' },
        { id: 'amd_otc', name: 'Advanced Micro Devices OTC', icon: 'https://img.icons8.com/color/100/amd.png', category: 'Stocks' },
        { id: 'fb_otc', name: 'Meta (Facebook) OTC', icon: 'https://img.icons8.com/color/100/meta.png', category: 'Stocks' },
        { id: 'citi_otc', name: 'Citigroup Inc OTC', icon: 'https://img.icons8.com/color/100/bank-building.png', category: 'Stocks' },
        { id: 'axp_otc', name: 'American Express OTC', icon: 'https://img.icons8.com/color/100/amex.png', category: 'Stocks' },
        { id: 'aapl_otc', name: 'Apple OTC', icon: 'https://img.icons8.com/color/100/mac-os.png', category: 'Stocks' },
        { id: 'intc_otc', name: 'Intel OTC', icon: 'https://img.icons8.com/color/100/intel.png', category: 'Stocks' },
        { id: 'coin_otc', name: 'Coinbase Global OTC', icon: 'https://img.icons8.com/color/100/coin-in-hand.png', category: 'Stocks' },
        { id: 'vix_otc', name: 'VIX OTC', icon: 'https://img.icons8.com/color/100/stocks.png', category: 'Stocks' },
        { id: 'jnj_otc', name: 'Johnson & Johnson OTC', icon: 'https://img.icons8.com/color/100/pills.png', category: 'Stocks' },
        { id: 'ba_otc', name: 'Boeing Company OTC', icon: 'https://img.icons8.com/color/100/airplane-mode-on.png', category: 'Stocks' },
        { id: 'nflx_otc', name: 'Netflix OTC', icon: 'https://img.icons8.com/color/100/netflix.png', category: 'Stocks' },
        { id: 'pfe_otc', name: 'Pfizer Inc OTC', icon: 'https://img.icons8.com/color/100/medical-doctor.png', category: 'Stocks' },
        { id: 'baba_otc', name: 'Alibaba OTC', icon: 'https://img.icons8.com/color/100/alibaba.png', category: 'Stocks' },
        { id: 'msft_otc', name: 'Microsoft OTC', icon: 'https://img.icons8.com/color/100/microsoft.png', category: 'Stocks' },
        { id: 'tsla_otc', name: 'Tesla OTC', icon: 'https://img.icons8.com/color/100/tesla-logo.png', category: 'Stocks' },
        { id: 'apple', name: 'Apple', icon: 'https://img.icons8.com/color/100/mac-os.png', category: 'Stocks' },
        { id: 'amex', name: 'American Express', icon: 'https://img.icons8.com/color/100/amex.png', category: 'Stocks' },
        { id: 'boeing', name: 'Boeing Company', icon: 'https://img.icons8.com/color/100/airplane-mode-on.png', category: 'Stocks' },
        { id: 'meta', name: 'Meta (Facebook)', icon: 'https://img.icons8.com/color/100/meta.png', category: 'Stocks' },
        { id: 'jnj', name: 'Johnson & Johnson', icon: 'https://img.icons8.com/color/100/pills.png', category: 'Stocks' },
        { id: 'jpm', name: 'JPMorgan Chase & Co', icon: 'https://img.icons8.com/color/100/bank-building.png', category: 'Stocks' },
        { id: 'mcdonalds', name: "McDonald's", icon: 'https://img.icons8.com/color/100/mcdonalds.png', category: 'Stocks' },
        { id: 'microsoft', name: 'Microsoft', icon: 'https://img.icons8.com/color/100/microsoft.png', category: 'Stocks' },
        { id: 'pfizer', name: 'Pfizer Inc', icon: 'https://img.icons8.com/color/100/medical-doctor.png', category: 'Stocks' },
        { id: 'tesla', name: 'Tesla', icon: 'https://img.icons8.com/color/100/tesla-logo.png', category: 'Stocks' },
        { id: 'alibaba', name: 'Alibaba', icon: 'https://img.icons8.com/color/100/alibaba.png', category: 'Stocks' },
        { id: 'citigroup', name: 'Citigroup Inc', icon: 'https://img.icons8.com/color/100/bank-building.png', category: 'Stocks' },
        { id: 'netflix', name: 'Netflix', icon: 'https://img.icons8.com/color/100/netflix.png', category: 'Stocks' },
        { id: 'cisco', name: 'Cisco', icon: 'https://img.icons8.com/color/100/cisco.png', category: 'Stocks' },
        { id: 'exxon', name: 'ExxonMobil', icon: 'https://img.icons8.com/color/100/gas-station.png', category: 'Stocks' },
        { id: 'intel', name: 'Intel', icon: 'https://img.icons8.com/color/100/intel.png', category: 'Stocks' }
    ],
    indices: [
        ...
        { id: 'aus200_index', name: 'AUS 200', icons: ['https://img.icons8.com/color/100/statistics.png', 'https://flagcdn.com/w40/au.png'], category: 'Indices' }
    ]
};
