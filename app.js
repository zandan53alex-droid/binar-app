...
const BOOKS = [
    ...
    { title: 'Дисциплинированный трейдер', icon: '🧠', size: '1.5 MB', file: 'disciplined_trader.pdf' },
    ...
    { title: 'Основы криптотрейдинга', icon: '₿', size: '9.3 MB', file: 'crypto_trading_basics.pdf' },
    { title: 'Психология трейдинга', icon: '🧠', size: '0.5 MB', file: 'trading_psychology.pdf' },
