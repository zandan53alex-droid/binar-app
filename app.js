const ASSETS_DB = {
    forex: [
        { id: 'eurcad', name: 'EUR/CAD', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'gbpusd', name: 'GBP/USD', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' },
        { id: 'cadchf', name: 'CAD/CHF', icon: 'https://flagcdn.com/w80/ca.png', category: 'Forex' },
        { id: 'audcad', name: 'AUD/CAD', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'audchf', name: 'AUD/CHF', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'eurusd', name: 'EUR/USD', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'gbpchf', name: 'GBP/CHF', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' },
        { id: 'eurgbp', name: 'EUR/GBP', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'cadjpy', name: 'CAD/JPY', icon: 'https://flagcdn.com/w80/ca.png', category: 'Forex' },
        { id: 'eurjpy', name: 'EUR/JPY', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'usdcad', name: 'USD/CAD', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'audjpy', name: 'AUD/JPY', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'usdjpy', name: 'USD/JPY', icon: 'https://flagcdn.com/w80/jp.png', category: 'Forex' },
        { id: 'gbpjpy', name: 'GBP/JPY', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' },
        { id: 'audusd', name: 'AUD/USD', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex' },
        { id: 'chfjpy', name: 'CHF/JPY', icon: 'https://flagcdn.com/w80/ch.png', category: 'Forex' },
        { id: 'eurchf', name: 'EUR/CHF', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'euraud', name: 'EUR/AUD', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex' },
        { id: 'gbpaud', name: 'GBP/AUD', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' },
        { id: 'usdchf', name: 'USD/CHF', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex' },
        { id: 'gbpcad', name: 'GBP/CAD', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex' }
    ],
    forex_otc: [
        { id: 'aedcny_otc', name: 'AED/CNY OTC', icon: 'https://flagcdn.com/w80/ae.png', category: 'Forex OTC' },
        { id: 'audcad_otc', name: 'AUD/CAD OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex OTC' },
        { id: 'audnzd_otc', name: 'AUD/NZD OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex OTC' },
        { id: 'audusd_otc', name: 'AUD/USD OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex OTC' },
        { id: 'bhdcny_otc', name: 'BHD/CNY OTC', icon: 'https://flagcdn.com/w80/bh.png', category: 'Forex OTC' },
        { id: 'cadchf_otc', name: 'CAD/CHF OTC', icon: 'https://flagcdn.com/w80/ca.png', category: 'Forex OTC' },
        { id: 'cadjpy_otc', name: 'CAD/JPY OTC', icon: 'https://flagcdn.com/w80/ca.png', category: 'Forex OTC' },
        { id: 'eurchf_otc', name: 'EUR/CHF OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex OTC' },
        { id: 'eurusd_otc', name: 'EUR/USD OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex OTC' },
        { id: 'nzdusd_otc', name: 'NZD/USD OTC', icon: 'https://flagcdn.com/w80/nz.png', category: 'Forex OTC' },
        { id: 'uahusd_otc', name: 'UAH/USD OTC', icon: 'https://flagcdn.com/w80/ua.png', category: 'Forex OTC' },
        { id: 'usdcop_otc', name: 'USD/COP OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdegp_otc', name: 'USD/EGP OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdidr_otc', name: 'USD/IDR OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdpkr_otc', name: 'USD/PKR OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdrub_otc', name: 'USD/RUB OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdcnh_otc', name: 'USD/CNH OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'eurnzd_otc', name: 'EUR/NZD OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex OTC' },
        { id: 'usdchf_otc', name: 'USD/CHF OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'eurgbp_otc', name: 'EUR/GBP OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex OTC' },
        { id: 'sarcny_otc', name: 'SAR/CNY OTC', icon: 'https://flagcdn.com/w80/sa.png', category: 'Forex OTC' },
        { id: 'eurtry_otc', name: 'EUR/TRY OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex OTC' },
        { id: 'eurrub_otc', name: 'EUR/RUB OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex OTC' },
        { id: 'qarcny_otc', name: 'QAR/CNY OTC', icon: 'https://flagcdn.com/w80/qa.png', category: 'Forex OTC' },
        { id: 'audjpy_otc', name: 'AUD/JPY OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex OTC' },
        { id: 'gbpusd_otc', name: 'GBP/USD OTC', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex OTC' },
        { id: 'usdbdt_otc', name: 'USD/BDT OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'omrcny_otc', name: 'OMR/CNY OTC', icon: 'https://flagcdn.com/w80/om.png', category: 'Forex OTC' },
        { id: 'usdbrl_otc', name: 'USD/BRL OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'eurjpy_otc', name: 'EUR/JPY OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex OTC' },
        { id: 'gbpaud_otc', name: 'GBP/AUD OTC', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex OTC' },
        { id: 'usdars_otc', name: 'USD/ARS OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdcad_otc', name: 'USD/CAD OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdsgd_otc', name: 'USD/SGD OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'kesusd_otc', name: 'KES/USD OTC', icon: 'https://flagcdn.com/w80/ke.png', category: 'Forex OTC' },
        { id: 'nzdjpy_otc', name: 'NZD/JPY OTC', icon: 'https://flagcdn.com/w80/nz.png', category: 'Forex OTC' },
        { id: 'usdclp_otc', name: 'USD/CLP OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'audchf_otc', name: 'AUD/CHF OTC', icon: 'https://flagcdn.com/w80/au.png', category: 'Forex OTC' },
        { id: 'gbpjpy_otc', name: 'GBP/JPY OTC', icon: 'https://flagcdn.com/w80/gb.png', category: 'Forex OTC' },
        { id: 'usdjpy_otc', name: 'USD/JPY OTC', icon: 'https://flagcdn.com/w80/jp.png', category: 'Forex OTC' },
        { id: 'madusd_otc', name: 'MAD/USD OTC', icon: 'https://flagcdn.com/w80/ma.png', category: 'Forex OTC' },
        { id: 'usdmxn_otc', name: 'USD/MXN OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdinr_otc', name: 'USD/INR OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdthb_otc', name: 'USD/THB OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'jodcny_otc', name: 'JOD/CNY OTC', icon: 'https://flagcdn.com/w80/jo.png', category: 'Forex OTC' },
        { id: 'tndusd_otc', name: 'TND/USD OTC', icon: 'https://flagcdn.com/w80/tn.png', category: 'Forex OTC' },
        { id: 'lbpusd_otc', name: 'LBP/USD OTC', icon: 'https://flagcdn.com/w80/lb.png', category: 'Forex OTC' },
        { id: 'chfnok_otc', name: 'CHF/NOK OTC', icon: 'https://flagcdn.com/w80/ch.png', category: 'Forex OTC' },
        { id: 'eurhuf_otc', name: 'EUR/HUF OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Forex OTC' },
        { id: 'yerusd_otc', name: 'YER/USD OTC', icon: 'https://flagcdn.com/w80/ye.png', category: 'Forex OTC' },
        { id: 'ngnusd_otc', name: 'NGN/USD OTC', icon: 'https://flagcdn.com/w80/ng.png', category: 'Forex OTC' },
        { id: 'usdmyr_otc', name: 'USD/MYR OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usdphp_otc', name: 'USD/PHP OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'chfjpy_otc', name: 'CHF/JPY OTC', icon: 'https://flagcdn.com/w80/ch.png', category: 'Forex OTC' },
        { id: 'usdvnd_otc', name: 'USD/VND OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Forex OTC' },
        { id: 'usddzd_otc', name: 'USD/DZD OTC', icon: 'https://flagcdn.com/w80/dz.png', category: 'Forex OTC' }
    ],
    crypto: [
