const ASSETS_DB = {
    ...
    crypto: [
        ...
        { id: 'bitcoin_otc', name: 'Bitcoin OTC', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/btc.png', category: 'Crypto' },
        ...
        { id: 'bitcoin_etf_otc', name: 'Bitcoin ETF OTC', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/btc.png', category: 'Crypto' },
        ...
        { id: 'dot_otc', name: 'Polkadot OTC', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/dot.png', category: 'Crypto' },
        ...
        { id: 'bitcoin', name: 'Bitcoin', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/btc.png', category: 'Crypto' },
        { id: 'ethereum', name: 'Ethereum', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/eth.png', category: 'Crypto' },
        { id: 'dash', name: 'Dash', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/dash.png', category: 'Crypto' },
        { id: 'bcheur', name: 'BCH/EUR', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/bch.png', category: 'Crypto' },
        { id: 'bchgbp', name: 'BCH/GBP', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/bch.png', category: 'Crypto' },
        { id: 'bchjpy', name: 'BCH/JPY', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/bch.png', category: 'Crypto' },
        { id: 'btcgbp', name: 'BTC/GBP', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/btc.png', category: 'Crypto' },
        { id: 'btcjpy', name: 'BTC/JPY', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/btc.png', category: 'Crypto' },
        { id: 'link', name: 'Chainlink', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a6353054d0074744154fa1f97371077e2336336/32/color/link.png', category: 'Crypto' }
    ],
    commodities: [
        { id: 'brent_oil_otc', name: 'Brent Oil OTC', icon: 'https://img.icons8.com/color/100/null/barrel.png', category: 'Commodities' },
        { id: 'wti_crude_oil_otc', name: 'WTI Crude Oil OTC', icon: 'https://img.icons8.com/color/100/null/oil-industry.png', category: 'Commodities' },
        { id: 'silver_otc', name: 'Silver OTC', icon: 'https://img.icons8.com/color/100/null/silver-bars.png', category: 'Commodities' },
        { id: 'gold_otc', name: 'Gold OTC', icon: 'https://img.icons8.com/color/100/null/gold-bars.png', category: 'Commodities' },
        { id: 'natgas_otc', name: 'Natural Gas OTC', icon: 'https://img.icons8.com/color/100/null/gas.png', category: 'Commodities' },
        { id: 'palladium_otc', name: 'Palladium spot OTC', icon: 'https://img.icons8.com/color/100/null/platinum-bars.png', category: 'Commodities' },
        { id: 'platinum_otc', name: 'Platinum spot OTC', icon: 'https://img.icons8.com/color/100/null/diamond-stone.png', category: 'Commodities' },
        { id: 'brent_oil', name: 'Brent Oil', icon: 'https://img.icons8.com/color/100/null/barrel.png', category: 'Commodities' },
        { id: 'wti_crude_oil', name: 'WTI Crude Oil', icon: 'https://img.icons8.com/color/100/null/oil-industry.png', category: 'Commodities' },
        { id: 'xageur', name: 'XAG/EUR', icon: 'https://img.icons8.com/color/100/null/silver-bars.png', category: 'Commodities' },
        { id: 'silver', name: 'Silver', icon: 'https://img.icons8.com/color/100/null/silver-bars.png', category: 'Commodities' },
        { id: 'xaueur', name: 'XAU/EUR', icon: 'https://img.icons8.com/color/100/null/gold-bars.png', category: 'Commodities' },
        { id: 'gold', name: 'Gold', icon: 'https://img.icons8.com/color/100/null/gold-bars.png', category: 'Commodities' },
        { id: 'natgas', name: 'Natural Gas', icon: 'https://img.icons8.com/color/100/null/gas.png', category: 'Commodities' },
        { id: 'palladium_spot', name: 'Palladium spot', icon: 'https://img.icons8.com/color/100/null/platinum-bars.png', category: 'Commodities' },
        { id: 'platinum_spot', name: 'Platinum spot', icon: 'https://img.icons8.com/color/100/null/diamond-stone.png', category: 'Commodities' }
    ],
    stocks: [
        { id: 'csco_otc', name: 'Cisco OTC', icon: 'https://img.icons8.com/color/100/null/cisco.png', category: 'Stocks' },
        { id: 'nflx_otc', name: 'Netflix OTC', icon: 'https://img.icons8.com/color/100/null/netflix.png', category: 'Stocks' },
        { id: 'baba_otc', name: 'Alibaba OTC', icon: 'https://img.icons8.com/color/100/null/alibaba.png', category: 'Stocks' },
        { id: 'axp_otc', name: 'American Express OTC', icon: 'https://img.icons8.com/color/100/null/amex.png', category: 'Stocks' },
        { id: 'msft_otc', name: 'Microsoft OTC', icon: 'https://img.icons8.com/color/100/null/microsoft.png', category: 'Stocks' },
        { id: 'citi_otc', name: 'Citigroup Inc OTC', icon: 'https://img.icons8.com/color/100/null/bank.png', category: 'Stocks' },
        { id: 'vix_otc', name: 'VIX OTC', icon: 'https://img.icons8.com/color/100/null/line-chart.png', category: 'Stocks' },
        { id: 'fb_otc', name: 'FACEBOOK INC OTC', icon: 'https://img.icons8.com/color/100/null/meta.png', category: 'Stocks' },
        { id: 'xom_otc', name: 'ExxonMobil OTC', icon: 'https://img.icons8.com/color/100/null/fuel-station.png', category: 'Stocks' },
        { id: 'gme_otc', name: 'GameStop Corp OTC', icon: 'https://img.icons8.com/color/100/null/game-controller.png', category: 'Stocks' },
        { id: 'coin_otc', name: 'Coinbase Global OTC', icon: 'https://img.icons8.com/color/100/null/coinbase.png', category: 'Stocks' },
        { id: 'mcd_otc', name: 'McDonald\'s OTC', icon: 'https://img.icons8.com/color/100/null/mcdonalds.png', category: 'Stocks' },
        { id: 'pfe_otc', name: 'Pfizer Inc OTC', icon: 'https://img.icons8.com/color/100/null/pills.png', category: 'Stocks' },
        { id: 'amd_otc', name: 'Advanced Micro Devices OTC', icon: 'https://img.icons8.com/color/100/null/amd.png', category: 'Stocks' },
        { id: 'aapl_otc', name: 'Apple OTC', icon: 'https://img.icons8.com/color/100/null/apple-logo.png', category: 'Stocks' },
        { id: 'ba_otc', name: 'Boeing Company OTC', icon: 'https://img.icons8.com/color/100/null/boeing.png', category: 'Stocks' },
        { id: 'amzn_otc', name: 'Amazon OTC', icon: 'https://img.icons8.com/color/100/null/amazon.png', category: 'Stocks' },
        { id: 'visa_otc', name: 'VISA OTC', icon: 'https://img.icons8.com/color/100/null/visa.png', category: 'Stocks' },
        { id: 'mara_otc', name: 'Marathon Digital Holdings OTC', icon: 'https://img.icons8.com/color/100/null/mining.png', category: 'Stocks' },
        { id: 'pltr_otc', name: 'Palantir Technologies OTC', icon: 'https://img.icons8.com/color/100/null/data-configuration.png', category: 'Stocks' },
        { id: 'intc_otc', name: 'Intel OTC', icon: 'https://img.icons8.com/color/100/null/intel.png', category: 'Stocks' },
        { id: 'apple', name: 'Apple', icon: 'https://img.icons8.com/color/100/null/apple-logo.png', category: 'Stocks' },
        { id: 'amex', name: 'American Express', icon: 'https://img.icons8.com/color/100/null/amex.png', category: 'Stocks' },
        { id: 'boeing', name: 'Boeing Company', icon: 'https://img.icons8.com/color/100/null/boeing.png', category: 'Stocks' },
        { id: 'meta', name: 'FACEBOOK INC', icon: 'https://img.icons8.com/color/100/null/meta.png', category: 'Stocks' },
        { id: 'jnj', name: 'Johnson & Johnson', icon: 'https://img.icons8.com/color/100/null/pills.png', category: 'Stocks' },
        { id: 'jpm', name: 'JPMorgan Chase & Co', icon: 'https://img.icons8.com/color/100/null/bank.png', category: 'Stocks' },
        { id: 'mcdonalds', name: 'McDonald\'s', icon: 'https://img.icons8.com/color/100/null/mcdonalds.png', category: 'Stocks' },
        { id: 'microsoft', name: 'Microsoft', icon: 'https://img.icons8.com/color/100/null/microsoft.png', category: 'Stocks' },
        { id: 'pfizer', name: 'Pfizer Inc', icon: 'https://img.icons8.com/color/100/null/pills.png', category: 'Stocks' },
        { id: 'tesla', name: 'Tesla', icon: 'https://img.icons8.com/color/100/null/tesla-logo.png', category: 'Stocks' },
        { id: 'alibaba', name: 'Alibaba', icon: 'https://img.icons8.com/color/100/null/alibaba.png', category: 'Stocks' },
        { id: 'citigroup', name: 'Citigroup Inc', icon: 'https://img.icons8.com/color/100/null/bank.png', category: 'Stocks' },
        { id: 'netflix', name: 'Netflix', icon: 'https://img.icons8.com/color/100/null/netflix.png', category: 'Stocks' },
        { id: 'cisco', name: 'Cisco', icon: 'https://img.icons8.com/color/100/null/cisco.png', category: 'Stocks' },
        { id: 'exxon', name: 'ExxonMobil', icon: 'https://img.icons8.com/color/100/null/fuel-station.png', category: 'Stocks' },
        { id: 'intel', name: 'Intel', icon: 'https://img.icons8.com/color/100/null/intel.png', category: 'Stocks' }
    ],
    indices: [
        ...
        { id: 'cac40_index', name: 'CAC 40', icon: 'https://flagcdn.com/w80/fr.png', category: 'Indices' },
        ...
        { id: 'e35eur_index', name: 'E35EUR', icon: 'https://flagcdn.com/w80/eu.png', category: 'Indices' },
        ...
        { id: 'us100_index', name: 'US100', icon: 'https://flagcdn.com/w80/us.png', category: 'Indices' },
        { id: 'us100_otc', name: 'US100 OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Indices' },
        { id: 'smi20_index', name: 'SMI 20', icon: 'https://flagcdn.com/w80/ch.png', category: 'Indices' },
        { id: 'sp500_index', name: 'SP500', icon: 'https://flagcdn.com/w80/us.png', category: 'Indices' },
        { id: 'sp500_otc', name: 'SP500 OTC', icon: 'https://flagcdn.com/w80/us.png', category: 'Indices' },
        { id: '100gbp_index', name: '100GBP', icon: 'https://flagcdn.com/w80/gb.png', category: 'Indices' },
        { id: 'aex25_index', name: 'AEX 25', icon: 'https://flagcdn.com/w80/nl.png', category: 'Indices' },
        { id: 'd30eur_index', name: 'D30/EUR', icon: 'https://flagcdn.com/w80/de.png', category: 'Indices' },
        { id: 'dji30_index', name: 'DJI30', icon: 'https://flagcdn.com/w80/us.png', category: 'Indices' },
        { id: 'e50eur_index', name: 'E50/EUR', icon: 'https://flagcdn.com/w80/eu.png', category: 'Indices' },
        { id: 'f40eur_index', name: 'F40/EUR', icon: 'https://flagcdn.com/w80/eu.png', category: 'Indices' },
        { id: 'f40eur_otc', name: 'F40EUR OTC', icon: 'https://flagcdn.com/w80/eu.png', category: 'Indices' },
        { id: 'hk33_index', name: 'HONG KONG 33', icon: 'https://flagcdn.com/w80/hk.png', category: 'Indices' },
        { id: 'jpn225_index', name: 'JPN225', icon: 'https://flagcdn.com/w80/jp.png', category: 'Indices' },
        { id: 'aus200_index', name: 'AUS 200', icon: 'https://flagcdn.com/w80/au.png', category: 'Indices' }
    ]
};
