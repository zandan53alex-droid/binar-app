const ASSETS_DB = {
    ...
    indices: [
        { id: 'aus200_otc', name: 'AUS 200 OTC', icon: 'https://img.icons8.com/color/100/australia-map.png', category: 'Indices' },
        { id: '100gbp_otc', name: '100GBP OTC', icon: 'https://img.icons8.com/color/100/london-eye.png', category: 'Indices' },
        { id: 'cac40_index', name: 'CAC 40', icon: 'https://img.icons8.com/color/100/eiffel-tower.png', category: 'Indices' },
        { id: 'd30eur_otc', name: 'D30EUR OTC', icon: 'https://img.icons8.com/color/100/brandenburg-gate.png', category: 'Indices' },
        { id: 'dji30_otc', name: 'DJI30 OTC', icon: 'https://img.icons8.com/color/100/statue-of-liberty.png', category: 'Indices' },
        { id: 'e35eur_index', name: 'E35EUR', icon: 'https://img.icons8.com/color/100/european-union.png', category: 'Indices' },
        { id: 'e35eur_otc', name: 'E35EUR OTC', icon: 'https://img.icons8.com/color/100/european-union.png', category: 'Indices' },
        { id: 'e50eur_otc', name: 'E50EUR OTC', icon: 'https://img.icons8.com/color/100/european-union.png', category: 'Indices' },
        { id: 'jpn225_otc', name: 'JPN225 OTC', icon: 'https://img.icons8.com/color/100/mt-fuji.png', category: 'Indices' },
        { id: 'us100_index', name: 'US100', icon: 'https://img.icons8.com/color/100/usa.png', category: 'Indices' },
        { id: 'us100_otc', name: 'US100 OTC', icon: 'https://img.icons8.com/color/100/usa.png', category: 'Indices' },
        { id: 'smi20_index', name: 'SMI 20', icon: 'https://img.icons8.com/color/100/switzerland-map.png', category: 'Indices' },
        { id: 'sp500_index', name: 'SP500', icon: 'https://img.icons8.com/color/100/usa.png', category: 'Indices' },
        { id: 'sp500_otc', name: 'SP500 OTC', icon: 'https://img.icons8.com/color/100/usa.png', category: 'Indices' },
        { id: '100gbp_index', name: '100GBP', icon: 'https://img.icons8.com/color/100/london-eye.png', category: 'Indices' },
        { id: 'aex25_index', name: 'AEX 25', icon: 'https://img.icons8.com/color/100/netherlands-map.png', category: 'Indices' },
        { id: 'd30eur_index', name: 'D30/EUR', icon: 'https://img.icons8.com/color/100/brandenburg-gate.png', category: 'Indices' },
        { id: 'dji30_index', name: 'DJI30', icon: 'https://img.icons8.com/color/100/statue-of-liberty.png', category: 'Indices' },
        { id: 'e50eur_index', name: 'E50/EUR', icon: 'https://img.icons8.com/color/100/european-union.png', category: 'Indices' },
        { id: 'f40eur_index', name: 'F40/EUR', icon: 'https://img.icons8.com/color/100/eiffel-tower.png', category: 'Indices' },
        { id: 'f40eur_otc', name: 'F40EUR OTC', icon: 'https://img.icons8.com/color/100/eiffel-tower.png', category: 'Indices' },
        { id: 'hk33_index', name: 'HONG KONG 33', icon: 'https://img.icons8.com/color/100/hong-kong.png', category: 'Indices' },
        { id: 'jpn225_index', name: 'JPN225', icon: 'https://img.icons8.com/color/100/mt-fuji.png', category: 'Indices' },
        { id: 'aus200_index', name: 'AUS 200', icon: 'https://img.icons8.com/color/100/australia-map.png', category: 'Indices' }
    ]
};
